...
local Metadata = {
	LoaderData = {
		...
		Colors = shared.LoaderColors or {
			...
			Title = Color3.fromRGB(255, 45, 33),
...
KaiTun2:AddToggle(
    {Name = "Auto farm", Value = false, Callback = function(value)
            getgenv().LevelFarm = value
            StopBodyClip(getgenv().LevelFarm)
        end}
)
KaiTun2:AddToggle(
    {Name = "White Screen", Value = false, Callback = function(value)
...
local KaiTun5 = KaiTun:CreateSection({Name = "Melee", Side = "Right"})
QuestAR = KaiTun:CreateSection({Name = "Quest", Side = "Right"})
...
KaiTun2:AddLabel({Name = "Fast ATTACK : ✅"})
...
PlayerName = KaiTun2:AddLabel({Name = ""})
Health = KaiTun2:AddLabel({Name = ""})
Energy = KaiTun2:AddLabel({Name = ""})
BountyHonorStast = KaiTun2:AddLabel({Name = ""})
LevelStast = KaiTun2:AddLabel({Name = ""})
EXP = KaiTun2:AddLabel({Name = ""})
FragmentsStast = KaiTun2:AddLabel({Name = ""})
BeliStast = KaiTun2:AddLabel({Name = ""})
DevilFruitStast = KaiTun2:AddLabel({Name = ""})
RaceStast = KaiTun2:AddLabel({Name = ""})
...
--------------------pages shop
local shop = PepsiUi:CreateTab({Name = "SHOP&DUNGEON"})
local NPCSELLER = shop:CreateSection({
    Name = "NPCSELLER", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local DUNGEON = shop:CreateSection({
    Name = "DUNGEON", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})
local meleeshop = shop:CreateSection({
    Name = "NPCSELLER", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})
local DUNGEONSHOP = shop:CreateSection({
    Name = "DUNGEONSHOP", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})
NPCSELLER:AddButton({
    Name = "Cutlass",
...
DUNGEONSHOP:AddButton({
    Name = "Flame",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Flame")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Ice",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Ice")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Quake",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Quake")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Light",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Light")
    end
})
DUNGEONSHOP:AddButton({
    Name = "String",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("String")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Rumble",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Rumble")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Dark",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Dark")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Buddha",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Human: Buddha")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Magma",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Magma")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Sand",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Sand")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Phoenix",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bird: Phoenix")
    end
})
DUNGEONSHOP:AddButton({
    Name = "Dough",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Dough")
    end
})
meleeshop:AddButton({
    Name = "Superhuman",
...
------------------------melee
local STATS = PepsiUi:CreateTab({Name = "STATS&MELEE"})
local STATS1 = STATS:CreateSection({
    Name = "STATS", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local MELEE = STATS:CreateSection({
    Name = "MELEE", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})
local Mastery = STATS:CreateSection({
    Name = "Mastery", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
MELEE:AddToggle({
...
local misc = PepsiUi:CreateTab({Name = "misc&autoitem"})
local misc1 = misc:CreateSection({
    Name = "misc", -- ชื่อ
    Side = "Left" -- ตำแหน่ง Left/Right
})
local autoitem = misc:CreateSection({
    Name = "autoitem", -- ชื่อ
    Side = "Right" -- ตำแหน่ง Left/Right
})
---------auto
...
autoitem:AddToggle({
    Name = "AutoDoughtBossv2",
	Value = false, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
		_G._G.AutoDoughtBossv2 = Value
    end
})
autoitem:AddToggle({
    Name = "AutoDoughtBoss",
...
autoitem:AddToggle({
	...
	Value = false, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
		_G.Scrap_Metal2 = Value
    end
})
autoitem:AddToggle({
    Name = "Radioactive_Meterial",
	Value = false, -- ปรับค่าToggle true/false or Config
    Callback = function(value)
		_G.Radioactive_Meterial = Value
    end
})
autoitem:AddToggle({
    Name = "Leather2",
        ...
        while wait() do
            pcall(
                function()
                    if getgenv().LevelFarm then
                        if
                            game:GetService("Players").localPlayer.Data.Stats.Melee.Level.Value == 2450 and
                                game:GetService("Players").localPlayer.Data.Stats.Defense.Level.Value == 2450
                         then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
                                "AddPoint",
                                "Sword",
...
function QuestCheck() 
    ...
    elseif ThirdSea then
		...
		elseif MyLevel == 2425 or MyLevel <= 2450 then
            ...
            NameMon = "Snow Demon"
            CFrameQuest = CFrame.new(-776.070862, 23.5809536, -14453.0078, 0.33384338, 0, -0.942628562, 0, 1, 0, 0.942628562, 0, 0.33384338)
